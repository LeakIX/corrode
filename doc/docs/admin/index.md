...
Corrode Admin provides a Django-like admin interface for your Rust applications.
...
See the [`corrode_admin` rustdoc](pathname:///corrode/rustdoc/corrode_admin/) for the full API with
