...
e2e-install: ## Install E2E test dependencies
	npm --prefix e2e install && npx --prefix e2e playwright install
...
e2e-test-ui: ## Run E2E tests with UI
	npx --prefix e2e playwright test --ui

.PHONY: e2e-test-headed
e2e-test-headed: ## Run E2E tests in headed mode
	npx --prefix e2e playwright test --headed

.PHONY: e2e-report
e2e-report: ## Show E2E test report
	npx --prefix e2e playwright show-report
