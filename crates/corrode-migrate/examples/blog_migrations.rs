...
//!
//! This example demonstrates how to use corrode-migrate to manage database
//! schema changes for a blog application with users, posts, and comments.
//!
//! Run with: cargo run --example blog_migrations -p corrode-migrate

use corrode_migrate::prelude::*;
use corrode_migrate::CorrodeMigration;
...
impl CorrodeMigration for Migration0001 {
...
impl CorrodeMigration for Migration0002 {
    const APP: &'static str = "blog";
...
impl CorrodeMigration for Migration0003 {
    const APP: &'static str = "blog";
...
impl CorrodeMigration for Migration0004 {
    const APP: &'static str = "blog";
...
impl CorrodeMigration for Migration0005 {
    const APP: &'static str = "blog";
...
async fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    println!("{}", "=".repeat(70));
    println!(" CORRODE-MIGRATE: Blog Application Example");
    println!("{}", "=".repeat(70));
    println!();
    ...
    executor.init().await?;
    println!("    Created corrode_migrations table\n");
