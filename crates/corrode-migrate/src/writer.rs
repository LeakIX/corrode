...
impl MigrationWriter {
    ...
    pub fn generate(&self) -> String {
        ...
        code.push_str("//!\n");
        code.push_str("//! This file was auto-generated by corrode-migrate.\n");
        code.push_str("//! Do not edit manually unless you know what you're doing.\n\n");

        // Imports
        code.push_str("use corrode_migrate::prelude::*;\n\n");

        // Struct definition
        code.push_str("pub struct Migration;\n\n");

        // Trait implementation
        code.push_str("impl CorrodeMigration for Migration {\n");
...
mod tests {
    ...
    fn test_generate_simple_migration() {
        ...
        assert!(code.contains("impl CorrodeMigration for Migration"));
