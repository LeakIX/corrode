...
//!
//! `corrode-migrate` provides a compile-time validated migration system inspired by Django,
//! where:
...
//! corrode-migrate makemigrations
//!
//! # Apply pending migrations
//! corrode-migrate migrate
//!
//! # Show migration status
//! corrode-migrate showmigrations
//!
//! # Rollback the last migration
//! corrode-migrate migrate --reverse
//! ```
...
mod tests {
    ...
    impl CorrodeMigration for TestMigration {
