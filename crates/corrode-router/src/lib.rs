...
//!
//! ```
//! use corrode_router::{Router, Request, Response};
//!
...
//!
//! ```
//! use corrode_router::{Request, Response};
//!
...
//!
//! ```
//! use corrode_router::{Router, LoggingMiddleware, AuthMiddleware,
//!     Request, Response};
//!
//! async fn handler(_req: Request) -> Response {
//!     Response::ok()
...
//!
//! ```
//! use corrode_router::{Router, RouteGroup, Request, Response};
//!
...
//! use corrode_router::{Router, Method, Request, Response};
//!
